// Użyj `window.onload`, aby mieć pewność, że cały kod zostanie wykonany
// dopiero po pełnym załadowaniu strony i wszystkich jej zasobów.
window.onload = function() {
    ...
    // Sprawdzenie, czy formularz logowania został znaleziony w DOM
    if (loginForm) {
        ...
        // Jeśli ten błąd nadal występuje, oznacza to, że problem leży w pliku index.html
        // lub w sposobie jego serwowania.
        console.error('Nie można odnaleźć formularza logowania o ID "login-form". Proszę zweryfikować plik index.html.');
        alert('Wystąpił krytyczny błąd inicjalizacji: brak formularza logowania. Skontaktuj się z administratorem.');
    }
};
