document.addEventListener('DOMContentLoaded', () => {
    ...
    function attachNumpadListeners() {
        ...
        elements.quantityInput.addEventListener('click', (e) => { e.preventDefault(); openNumpad(e.target, (newValue) => { e.target.value = newValue; }); });
        elements.inventoryQuantityInput.addEventListener('click', (e) => { e.preventDefault(); openNumpad(e.target, (newValue) => { e.target.value = newValue; }); });
    }
